...
## 📘 getCodingKnowledge
Un widget de affichage d'une carte méteo outilisant APIs :
- Definition de la ville
- Affichage des données mèteo
...
## 📝 ToDo
### ToDov1. ToDo verision 1. Une version simplifiée d’un gestionnaire de tâches :
...
>
> ### ToDov2. ToDo verision 1. Une version d’un gestionnaire de tâches :
- Ajout, édition et suppression de tâches
- Interface minimaliste
- Stockage en base de données

> **Techs :** HTML, Bootstrap (CDN),, Reac
...
## 🔢 Digit
Un projet créatif ou expérimental :
- Simulation du jeu de cartes Digit
...
```bash
git clone https://github.com/ManzanaresDev/projets.git
cd <nom-du-projet>
Pour les projets dévelopés avec React:
npm install
npm run dev
